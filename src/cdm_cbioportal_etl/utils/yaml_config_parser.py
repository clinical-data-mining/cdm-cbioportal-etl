...
class YamlParser(object):
    ...
    def return_dict_copy_to_minio(self):
        dict_deid_filenames_deid_minio = self.return_filenames_deid_minio()
        ...
        combined_dict = {
            dict_deid_filenames_deid_datahub[key]: dict_deid_filenames_deid_minio[key]
            for key in dict_deid_filenames_deid_datahub
            if key in dict_deid_filenames_deid_minio
        }
