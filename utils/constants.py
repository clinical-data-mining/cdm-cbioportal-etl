...
DICT_FILES_TO_COPY = {
    ...
    config_cdm.fname_save_timeline_tumor_sites: config_cdm.fname_save_timeline_tumor_sites_minio,
...
DICT_FILES_TIMELINE = {
    ...
    config_cdm.fname_tumor_sites_timeline_cbio: config_cdm.fname_save_timeline_tumor_sites
}
