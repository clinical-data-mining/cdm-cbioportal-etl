...
from lib.utils import constants, detect_header_row_count
...
def main():
    ...
    df_samples_used = pd.read_csv(args.fname_sample, sep='\t', header=detect_header_row_count(args.fname_sample))
